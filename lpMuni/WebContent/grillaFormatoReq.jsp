		...
		<tr>
			...
			<td width=691 height=400 valign="middle"  style="padding:25px">
				<form action="FormatoServlet" id="data">
					<input type="hidden" name="operacion" value="cargaFormularioFormato">
				    <table align="center" class="control">
				      <tr>
					    <td colspan="2"><h2>Seleccione Formato Requerimiento:</h2></td>
					  </tr>
					   <tr>
					    <td><br/>
					    	<!-- id  Es identificador para JavaScript y var es el identificador para Java-Html -->
					    	<jmesa:tableModel id="datito" items="${requestScope.listarfr}" var="data" >
					    		    <jmesa:htmlTable>
										<jmesa:htmlRow>
											<jmesa:htmlColumn title="">
												<input type="radio" name="seleccionRadio" class="required" value="${data.codFormato}"/>
											</jmesa:htmlColumn>
											...
											<jmesa:htmlColumn title="codUsuario" width="70" property="detallePac.codDetallePac" sortOrder="asc,desc" />
										</jmesa:htmlRow>    		    
					    		    </jmesa:htmlTable>
					    	</jmesa:tableModel>
					    </td>
