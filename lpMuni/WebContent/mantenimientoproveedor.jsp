...
<%@page import="com.java.seguridad.services.ProveedorService"%>
...
<%
	...
	ProveedorService objDao = new ProveedorService(new HttpServletRequestWebContext(request));
	...
	request.setAttribute("proveedores", objDao.getProveedores());
	...
	<table width=955 >
		<tr>
			...
			<td width=691 height=400 valign="middle"  style="padding:25px">
					  	<hr class="space" />
		<p>${saveResults}</p>
  	  <form name="beansitosForm" id="beansitosForm" action="mantenimientoproveedor.jsp">
		...
		<jmesa:tableModel 
			...
			<jmesa:htmlTable 
				...
				<jmesa:htmlRow uniqueProperty="codProveedor">
					...
					<jmesa:htmlColumn property="ruc" title="Ruc"
						worksheetValidation="required:true"
						customWorksheetValidation="customFirstNameValidation:validateFirstName"
						errorMessage="customFirstNameValidation:You cannot use foo as a value" />
					<jmesa:htmlColumn property="telefono" title="Telefono"
						worksheetValidation="required:true"
						customWorksheetValidation="customFirstNameValidation:validateFirstName"
						errorMessage="customFirstNameValidation:You cannot use foo as a value" />
					<jmesa:htmlColumn property="correo" title="E-mail"
						worksheetValidation="required:true"
						customWorksheetValidation="customFirstNameValidation:validateFirstName"
						errorMessage="customFirstNameValidation:You cannot use foo as a value" />											
				</jmesa:htmlRow>
